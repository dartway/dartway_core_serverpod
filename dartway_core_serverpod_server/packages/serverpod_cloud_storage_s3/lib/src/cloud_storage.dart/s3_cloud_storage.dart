...
class S3CloudStorage extends CloudStorage {
  ...
  late final String endpoint; // DartWay fix
  ...
  Future<Uri?> getPublicUrl({
    ...
    if (await fileExists(session: session, path: path)) {
      return Uri.parse('$endpoint/$path'); // DartWay fix
    }
    return null;
  }
